...
var file_plant_service_proto_rawDesc = []byte{
	...
	0x25, 0x2e, 0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x6d, 0x69,
	...
	0x67, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x2e, 0x70, 0x6c, 0x61, 0x6e, 0x74, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
...
var file_plant_service_proto_goTypes = []interface{}{
	(*CreatePlantRequest)(nil),  // 0: golang_grpc_microservice.plant.CreatePlantRequest
	(*CreatePlantResponse)(nil), // 1: golang_grpc_microservice.plant.CreatePlantResponse
	(*Plant)(nil),               // 2: golang_grpc_microservice.plant.Plant
}
var file_plant_service_proto_depIdxs = []int32{
	2, // 0: golang_grpc_microservice.plant.CreatePlantRequest.plant:type_name -> golang_grpc_microservice.plant.Plant
	0, // 1: golang_grpc_microservice.plant.PlantService.CreatePlant:input_type -> golang_grpc_microservice.plant.CreatePlantRequest
	1, // 2: golang_grpc_microservice.plant.PlantService.CreatePlant:output_type -> golang_grpc_microservice.plant.CreatePlantResponse
...
func (c *plantServiceClient) CreatePlant(ctx context.Context, in *CreatePlantRequest, opts ...grpc.CallOption) (*CreatePlantResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/golang_grpc_microservice.plant.PlantService/CreatePlant", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PlantService_CreatePlant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/golang_grpc_microservice.plant.PlantService/CreatePlant",
	}
